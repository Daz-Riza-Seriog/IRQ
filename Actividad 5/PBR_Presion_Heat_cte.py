...
def PBR_calc_f(W, x, Rate, Reactor):
    ...
    dTadV = 0  # - (Rate.Ua / Reactor.rc) * (T - Ta) / (Reactor.F_cool * Rate.Cp_cool)  # Co-Current Balance
...
class plot_results:
    ...
    axs[0, 0].set_title("PBR Heat Constant\nCatalizador vs Flujo")
    ...
    axs[0, 1].set_title("PBR Heat Constant\n Catalizador vs Caida Presion")
    ...
    axs[1, 0].set_title("PBR Heat Constant\n Temperatura Ta vs T")
    ...
    axs[1, 1].set_title("PBR Heat Constant\n Temperatura Ta vs T")
