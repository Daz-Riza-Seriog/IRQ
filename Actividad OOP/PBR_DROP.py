...
sol_PBR_1 = solve_ivp(ODE_1.dFdW,[0, Reactor.V_tot_su], ini_state.x_0, t_eval=t_eval, rtol=1e-12,
                    atol=1e-12)
sol_PBR_2 = solve_ivp(ODE_2.dFdW,[0, Reactor.V_tot_su], ini_state.x_1, t_eval=t_eval, rtol=1e-12,
                    atol=1e-12)
